...
/* USER CODE BEGIN EC */
#define CUSTOM_STM_CHANNEL_IMU        1U
#define CUSTOM_STM_CHANNEL_CMD        2U
#define CUSTOM_STM_CHANNEL_CMD_ACK    3U
#define CUSTOM_STM_CHANNEL_RECORD     4U
#define CUSTOM_STM_CHANNEL_RECOVERY   5U

#define CUSTOM_STM_CMD_WRITE_NO_RESP_EVT CUSTOM_STM_PIPECTRLRX_WRITE_NO_RESP_EVT
