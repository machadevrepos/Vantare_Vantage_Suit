...
#define CFG_LP_CONN_ADV_INTERVAL_MIN      (0x0018)     /**< 1s */
#define CFG_LP_CONN_ADV_INTERVAL_MAX      (0x0030)     /**< 2.5s */
 ...
 */
#define CFG_GAP_DEVICE_NAME             "HUB0001"
 ...
 */
/* Extra TX/RX buffers above the stack minimum so the controller can pack more
 * 2M/DLE packets into each connection event, raising single-link node-upload
 * throughput. 16 blocks x BLE_MEM_BLOCK_SIZE (32 B) = 512 B of extra BLE pool
 * RAM (fits within the restored 128 KB SRAM1 budget). */
...
#define CFG_BLE_MAX_ATT_MTU             (247)
#undef L2CAP_REQUEST_NEW_CONN_PARAM
#define L2CAP_REQUEST_NEW_CONN_PARAM             1
#undef L2CAP_INTERVAL_MIN
#define L2CAP_INTERVAL_MIN              CONN_P(15)
#undef L2CAP_INTERVAL_MAX
#define L2CAP_INTERVAL_MAX              CONN_P(30)
#undef L2CAP_PERIPHERAL_LATENCY
#define L2CAP_PERIPHERAL_LATENCY             0x0000
#undef L2CAP_TIMEOUT_MULTIPLIER
#define L2CAP_TIMEOUT_MULTIPLIER        0x00C8
