...
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'L', '0', '1', '0', '1',  /* Complete name */
...
static void EXO_Node_UpdateAdvName(void)
{
  uint8_t node_id = exo_node_ble_runtime_id();
  if (node_id > 99U)
  {
    node_id = 99U;
  }
  a_AdvData[2] = (uint8_t)'L';
  a_AdvData[3] = (uint8_t)'0';
  a_AdvData[4] = (uint8_t)'0';
  a_AdvData[5] = (uint8_t)('0' + (node_id / 10U));
